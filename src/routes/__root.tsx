...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "SikaFlow — Sales Tally System" },
      { name: "description", content: "Track sales, inventory and expenses with the simple SikaFlow dashboard. Start a 30-day free trial." },
      { property: "og:title", content: "SikaFlow — Sales Tally System" },
      { property: "og:description", content: "Track sales, inventory and expenses with SikaFlow." },
