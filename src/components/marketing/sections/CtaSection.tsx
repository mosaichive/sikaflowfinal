    ...
    <section className="relative py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-[#2C8603]/28 via-[#2C8603]/18 to-cyan-500/24 p-10 sm:p-16 text-center"
        >
          {/* Animated bg shapes */}
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 60, repeat: Infinity, ease: 'linear' }}
            className="absolute -top-40 -left-20 w-[480px] h-[480px] rounded-full bg-gradient-to-br from-[#2C8603]/32 to-transparent blur-3xl"
          />
          <motion.div
            animate={{ rotate: -360 }}
