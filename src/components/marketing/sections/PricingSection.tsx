            ...
            return (
              <motion.div
                ...
                className={`relative rounded-3xl p-7 backdrop-blur-xl ${
                  p.highlight
                    ? 'border border-violet-400/40 bg-gradient-to-br from-violet-600/20 via-fuchsia-500/10 to-cyan-400/10 shadow-[0_30px_80px_-20px_rgba(139,92,246,0.5)]'
                    : 'border border-white/10 bg-white/[0.03]'
                }`}
              >
                {p.highlight && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-violet-500 to-cyan-400 text-black text-[10px] font-bold px-3 py-1 uppercase tracking-widest">
                ...
                <Button
                  ...
                  className={`mt-6 w-full rounded-full h-11 ${
                    p.highlight
                      ? 'bg-gradient-to-r from-violet-500 to-cyan-400 text-black font-semibold hover:opacity-90'
