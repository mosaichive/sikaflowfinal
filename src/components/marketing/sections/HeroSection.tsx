      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-[1.05fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              Track Sales.{" "}
              <span className="bg-gradient-to-r from-[#2C8603] via-[#2C8603] to-[#2C8603] bg-clip-text text-transparent">
                Control Stock.
              </span>
              <br />
              Know Your Money.
            ...
            >
              <Button
                asChild
                className="h-12 px-7 rounded-full bg-gradient-to-r from-[#2C8603] to-[#2C8603] text-white font-semibold hover:opacity-90 shadow-[0_8px_24px_rgba(44,134,3,0.12)]"
              >
                <Link to="/sign-up">
          ...
          <div className="relative h-[460px] sm:h-[520px]">
            ...
            <motion.div
              ...
              className="relative h-full rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl p-6 sm:p-8 shadow-[0_30px_120px_-30px_rgba(44,134,3,0.28)] overflow-hidden"
            >
              {/* glow ring */}
...
function FlyerSlider() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(44,134,3,0.16),transparent_34%),radial-gradient(circle_at_82%_26%,rgba(34,211,238,0.18),transparent_32%)]" />
      <div className="relative flex flex-col gap-5 lg:grid lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:items-center">
        ...
        <div className="relative mx-auto w-full max-w-[320px] sm:max-w-[430px] lg:col-start-2 lg:row-span-2 lg:row-start-1">
          <div className="absolute -inset-5 rounded-[2.4rem] bg-gradient-to-br from-[#2C8603]/20 via-cyan-400/10 to-emerald-400/20 blur-2xl" />
