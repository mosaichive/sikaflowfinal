    ...
    <section id="dashboard" className="relative py-24 sm:py-32">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="relative mt-16">
          <div className="absolute inset-x-10 top-10 h-72 bg-gradient-to-r from-[#51C11F]/24 via-[#45A91A]/20 to-cyan-400/24 blur-3xl opacity-60 pointer-events-none" />
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] backdrop-blur-xl p-5 shadow-[0_8px_24px_rgba(81,193,31,0.12)] sm:p-8"
          >
  ...
  return (
    ...
    >
      <div className="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        <KpiCard icon={TrendingUp} label="Daily Sales" value={12480} prefix="GHS " accent="from-[#51C11F]/18 to-[#45A91A]/6" />
        <KpiCard icon={BarChart3} label="Profit" value={3920} prefix="GHS " accent="from-emerald-500/20 to-teal-500/5" />
        <KpiCard icon={Receipt} label="Expenses" value={1640} prefix="GHS " accent="from-[#51C11F]/18 to-[#45A91A]/6" />
          ...
          <div className="flex h-44 items-end gap-2">
            {[40, 55, 48, 70, 60, 85, 95].map((h, i) => (
              <motion.div
                ...
                className="flex-1 rounded-md bg-gradient-to-t from-[#51C11F] to-[#45A91A] opacity-90"
              />
            ))}
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#0b0f15]/90 shadow-[0_30px_90px_-40px_rgba(34,211,238,0.55)]">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#51C11F]/10 via-transparent to-cyan-400/10" />
        <video
      ...
      <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.04] p-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[#51C11F] to-[#45A91A] text-white">
...
function MobileMockup() {
  return (
    ...
    >
      <div className="h-72 rounded-[1.4rem] bg-gradient-to-br from-[#51C11F]/28 to-cyan-900/36 p-4">
          ...
          {[60, 80, 45, 70].map((w, i) => (
            <div key={i} className="h-2 overflow-hidden rounded-full bg-white/10">
              <motion.div
                ...
                className="h-full bg-gradient-to-r from-[#51C11F] to-[#45A91A]"
              />
            </div>
          ))}
        </div>
