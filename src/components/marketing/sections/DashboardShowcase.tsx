...
function VideoPreview() {
  return (
    <motion.div
      ...
      className="mt-6"
    >
      <div className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-black/70 shadow-[0_30px_90px_-40px_rgba(34,211,238,0.55)]">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-violet-500/10 via-transparent to-cyan-400/10" />
        <video
          className="relative aspect-video w-full bg-black object-contain"
...
function MobileMockup() {
  return (
    <motion.div
      ...
      className="hidden xl:block absolute -right-6 -bottom-10 w-56 rounded-[2rem] border border-white/15 bg-black/80 p-3 shadow-2xl backdrop-blur"
    >
